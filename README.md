...
<p><em>/# The "generate_sliding.sh" described below uses bedtools, please check if bedtools is installed on your computer</em><br>
...
<em>\________# shift window</em></br>
<em>\________previousend=$(echo "$end")</em></br>
<em>\________start=$(echo "$end + 1" | bc)</em></br>
<em>\________end=$(echo "$previousend + $windowsize" | bc)</em></br>
<em>\____done</em></br>
