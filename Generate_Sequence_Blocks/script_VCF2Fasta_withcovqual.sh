...
python /home/thibault/scripts/jointVCFoutils/FiltrationDepthCoverageQualityJointVCF_PASSLowQ_variantonly.py $file.qual > $file.qualsummary
python /home/thibault/scripts/jointVCFoutils/computeDepthCoverageQualityJointVCF_variantonly.py $file > $file.qualsummary.ind
...
sed "s;~/Collab/Montpellier/Colivacea_CovQual_joinVcf/Colivacea_FiltrationQualityjointVCF_variantonly_allsites_060218.PROV.30pc.sed.withoutNA;$file.qualsummary;g" /home/thibault/scripts/Rscripts/script_coverage_R_gvcf.R | sed "s;C_olivacea_summary_calling_newFilteredGVCF_060218.pdf;$file.qualsummary.pdf;g" | sed "s;summary_statistics_coverage;$file.99CI;g" | sed "s;~/Collab/Montpellier/Colivacea_CovQual_joinVcf/Colivacea_bidon;$file.qualsummary.ind.clean;g" >  /home/thibault/scripts/Rscripts/script_coverage_R_gvcf.R.$infilename.tmp
echo "[INFO] starting R computations"
Rscript /home/thibault/scripts/Rscripts/script_coverage_R_gvcf.R.$infilename.tmp
...
cd $outputdir
python /home/thibault/scripts/VCF2Fasta_fast.py -q $cutoffquality -m $cutoffcovmin -M $cutoffcovmax -f $file > $outputdir/Outputs_VCF2Fasta.txt
